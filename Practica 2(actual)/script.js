...
var controller = app.controller('InvoiceController', ($scope) => {
    ...
    $scope.products = [
        {id: 1, name: 'Villa Tunari', description: 'Villa Tunari is famous among tourists due to the tropical weather and due to nearby national parks.', price: 2000},
        {id: 2, name: 'Tiwanaku', description: 'Located near La Paz city, it is undoubtedly one of the most outstanding cultural places in our country.' , price: 1000},
